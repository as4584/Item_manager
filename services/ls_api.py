...
class LightspeedAPI:
    ...
    def get_inventory_by_location(self, location_id: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    def get_sales(self, from_date: str, to_date: str, location_id: Optional[str] = None) -> List[Dict[str, Any]]:
